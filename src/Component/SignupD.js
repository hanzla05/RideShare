...
<View style={{ height: 80, backgroundColor: '#043927', borderBottomStartRadius: 40, borderBottomEndRadius: 40, justifyContent: "center" }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' }}>
          ...
          <View style={{}}>
            <Text style={{ fontSize: 18, fontWeight: 'bold', color: 'white' }}>Register As Rider</Text>
          </View>
...
<ScrollView>
            <Camera/>
            <View style={{margin:'3%', padding :5, marginTop:3}}>  
      ...
      <TextInput
        ...
        value={email}
      />
       <Text style={styles.text}>Vehicle ID</Text>
      <TextInput
        style={styles.input}
